...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220223063532_Updated_Plan_Tables")]
    partial class Updated_Plan_Tables
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("f4ebc47a-75fe-43ec-ad00-e05f4b05d985"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("f3eb9def-e0a4-4b89-8bb8-c25eec1c1e33"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("caf4765b-d3a0-4154-917c-f79280fcce36"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("149ee338-19da-4ca3-b253-761b5f74e7f8"),
                            DateCreated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2123),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2136),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("3dcac47b-5afb-4dd4-aa4f-feefb2dce496"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2280),
                            DateUpdated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2280),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a7652f0d-7173-4014-88f8-93d8984a5177"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2283),
                            DateUpdated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2284),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("638541b4-2371-43f9-909d-48637489e09c"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2285),
                            DateUpdated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2285),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("06015ec9-9a93-4fe1-be36-43556a7b17f1"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2287),
                            DateUpdated = new DateTime(2022, 2, 23, 7, 35, 30, 869, DateTimeKind.Local).AddTicks(2287),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
