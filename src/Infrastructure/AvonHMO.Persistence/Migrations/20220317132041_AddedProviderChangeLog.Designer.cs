...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220317132041_AddedProviderChangeLog")]
    partial class AddedProviderChangeLog
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("027788f7-a68a-4ce5-ac4f-63b70c87a5c5"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("c5f2211f-b97a-4e95-9292-3ff4de36c155"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("92b988a2-889b-4227-afc9-2482d24ade7b"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("be8a91c4-e785-4c98-ada9-97330d3fadc3"),
                            DateCreated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4516),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4532),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("0afe783c-12ae-431b-b0e3-1e1ad04aa9a6"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4715),
                            DateUpdated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4715),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6da5fd75-97ac-4eaa-8ba1-10695d1afef3"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4718),
                            DateUpdated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4718),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e294dd4e-5cb1-46a7-a25d-8546491916e9"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4720),
                            DateUpdated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4720),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("0cd4c5da-0421-4286-b0fe-4896936754c5"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4721),
                            DateUpdated = new DateTime(2022, 3, 17, 14, 20, 39, 847, DateTimeKind.Local).AddTicks(4722),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
