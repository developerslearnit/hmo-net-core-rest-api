...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220217111701_17-02-2022")]
    partial class _17022022
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("499b9aac-d4aa-4353-99c1-b0bfbc304e07"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("297f9e67-cf66-42d7-97c1-1eebe190322b"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("86df62d5-085a-4e00-8f29-069d3d3709e8"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("a132f122-931e-453b-a328-cd186abaec4d"),
                            DateCreated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(8774),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(8800),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("fb629031-480c-4e10-ab68-30c1693c33a9"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9072),
                            DateUpdated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9072),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("dd6a5d56-160a-4836-99fd-6aaeff4fa24e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9075),
                            DateUpdated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9075),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7b186b9e-841a-474c-a9a9-00faf7236386"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9077),
                            DateUpdated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9077),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3eac7b57-3cc9-4198-b0cd-cf2ffcfcfb27"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9078),
                            DateUpdated = new DateTime(2022, 2, 17, 12, 17, 0, 433, DateTimeKind.Local).AddTicks(9079),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
