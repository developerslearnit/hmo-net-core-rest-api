...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220316121030_Toba_Only_Update_02")]
    partial class Toba_Only_Update_02
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("3f0df57d-1d02-48f4-8c54-895a7084305c"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("ac40b62a-08b3-4443-93e9-08b0b69c4359"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("5bca8c63-8371-4826-9d2e-9e6d72d02db4"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("03714c7e-27f0-443c-9244-dadc197b3a2b"),
                            DateCreated = new DateTime(2022, 3, 16, 13, 10, 28, 214, DateTimeKind.Local).AddTicks(9951),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 16, 13, 10, 28, 214, DateTimeKind.Local).AddTicks(9968),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("9605a236-e66d-4323-a3ad-4ca439ab16c0"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(154),
                            DateUpdated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(154),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("9d85833c-135e-455d-a506-31893a79fefa"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(156),
                            DateUpdated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(157),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7ae7cc65-54e8-4d09-b6b8-6ee7651b54ef"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(158),
                            DateUpdated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(159),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e47a4561-4d87-4d87-b646-dad19b2a931d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(160),
                            DateUpdated = new DateTime(2022, 3, 16, 13, 10, 28, 215, DateTimeKind.Local).AddTicks(161),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
