...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220317101507_Simeons_update_17_03_2022")]
    partial class Simeons_update_17_03_2022
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("32a4141e-25a4-4c10-bde0-516917798841"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("4bcb3ae9-ae07-43c1-b631-17dd4c7b30ea"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("65760f9c-dc9c-4e35-93fc-29c5f6d0a09b"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("6126eb0b-f46b-42de-8791-0beb40091eaa"),
                            DateCreated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2544),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2560),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("f32fc052-f25c-40a6-b725-de697f2cac4e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2703),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2704),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("0feb927a-9e59-4b45-a786-cdee2773b832"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2706),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2706),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3bb39042-d00a-4a7f-9768-382eb56ac454"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2708),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2708),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("420fa37b-2e27-4f38-a65e-3b858f667eeb"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2710),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 15, 6, 361, DateTimeKind.Local).AddTicks(2710),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
