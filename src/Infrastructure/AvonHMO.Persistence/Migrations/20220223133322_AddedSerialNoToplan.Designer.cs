...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220223133322_AddedSerialNoToplan")]
    partial class AddedSerialNoToplan
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("b1c79294-013a-4c69-aa39-f3a16813d745"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("b308276a-9011-4161-8938-0b0b269c8b6d"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("753569b7-85eb-488d-bf46-daf76296e4bf"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("2fa64809-5361-41e6-9460-355d7ae09814"),
                            DateCreated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8128),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8144),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("39ade2e3-be11-4439-910f-6e3634194548"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8264),
                            DateUpdated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8265),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a4b319d0-cd42-4965-a7a1-17c9f117b66f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8267),
                            DateUpdated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8268),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("811ef985-4b16-4a80-bd92-51c848b24df8"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8269),
                            DateUpdated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8270),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("84f57e3e-add9-4c75-a3ca-0b3f5742c1a0"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8271),
                            DateUpdated = new DateTime(2022, 2, 23, 14, 33, 20, 501, DateTimeKind.Local).AddTicks(8272),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
