...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220308061400_Added_request_transfer")]
    partial class Added_request_transfer
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("4ef16fe2-8691-44d8-8b04-6a4340daffdb"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("d300a8fd-655a-4f8c-9132-0dac686a4c53"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("f1eaaf2f-1e04-43f2-84c4-565ecfa3ad46"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("7cb556cb-46b2-49f7-82fc-0d784bc22b90"),
                            DateCreated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6104),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6123),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("5d86b751-8c9e-435d-94d1-132ba073f789"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6239),
                            DateUpdated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6240),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("2e8e9206-93d5-44fa-aba2-98f5074bc6bb"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6242),
                            DateUpdated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6243),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("8839d8b0-ae14-4d67-86d3-9fee63bdc769"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6244),
                            DateUpdated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6245),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("d1674888-5f2c-4529-8cfa-d89be206ac94"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6246),
                            DateUpdated = new DateTime(2022, 3, 8, 7, 13, 58, 483, DateTimeKind.Local).AddTicks(6247),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
