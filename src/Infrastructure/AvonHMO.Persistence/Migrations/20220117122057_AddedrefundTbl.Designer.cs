...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220117122057_AddedrefundTbl")]
    partial class AddedrefundTbl
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("e5c0e2db-12fa-455d-a619-a0d2247b412a"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("887584a4-01cb-4250-b464-39f8457ed8c6"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("1df34cb3-5e1a-4a49-999e-0b2a322d2a4a"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("c5bd3e90-52c3-4ec6-9fa8-81301d40d0e0"),
                            DateCreated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8734),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8745),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("7a1c36c7-abe7-4fab-8c9f-875dd5d82fbf"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8928),
                            DateUpdated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8929),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("516153d1-9cce-4e72-8e2c-ce11ef70dcb5"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8932),
                            DateUpdated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8932),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("911b6087-f743-4151-b8e9-e9cdc4ed8fad"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8935),
                            DateUpdated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8935),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("04f9d41b-fed7-4ca8-bea1-11916668ff47"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8937),
                            DateUpdated = new DateTime(2022, 1, 17, 13, 20, 57, 191, DateTimeKind.Local).AddTicks(8937),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
