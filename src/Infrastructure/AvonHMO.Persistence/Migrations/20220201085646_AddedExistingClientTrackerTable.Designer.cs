...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220201085646_AddedExistingClientTrackerTable")]
    partial class AddedExistingClientTrackerTable
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("9c3f821e-69da-419f-b7f5-ed6cfa69e4d6"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("93f6c8f5-24fc-48e8-bffe-cdf9f63127bc"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("c13f77b0-1831-444c-a0bc-57646ec8e653"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("9661bbb4-2d1b-41db-be0c-8cdec794c4a6"),
                            DateCreated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(631),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(644),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("c3f0dbe8-cb86-4f4a-9915-b0ecbdc2dea5"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(778),
                            DateUpdated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(779),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("729f3d25-121a-45b6-83cc-ae552dc6bd72"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(781),
                            DateUpdated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(782),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7c2de483-f1fd-47de-9353-c1c3cd48db0d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(784),
                            DateUpdated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(784),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("fbbe8857-41e6-4925-a631-218e34adc451"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(795),
                            DateUpdated = new DateTime(2022, 2, 1, 9, 56, 45, 921, DateTimeKind.Local).AddTicks(795),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
