...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220119134516_SimeonDev_RequestAuth")]
    partial class SimeonDev_RequestAuth
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("af329d80-4f93-477b-8d94-52d5456f854d"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("0aebc834-4868-41bc-8ceb-45ae9c4462d5"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("676ccbdd-fc29-48b1-8910-80c458045fc6"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("cfd37306-ff1c-42ac-9bc4-11d186ba8835"),
                            DateCreated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8435),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8454),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("dd3c4fd1-ccea-4100-bdbe-5db87c6672b6"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8663),
                            DateUpdated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8663),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("2909b555-0ecc-4deb-8a86-3637fd3a6c01"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8666),
                            DateUpdated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8667),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("d805477a-6f62-4bea-bc5a-23336668eb7f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8684),
                            DateUpdated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8684),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e6da9682-d5b7-4367-9902-937230325d73"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8686),
                            DateUpdated = new DateTime(2022, 1, 19, 14, 45, 16, 0, DateTimeKind.Local).AddTicks(8687),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
