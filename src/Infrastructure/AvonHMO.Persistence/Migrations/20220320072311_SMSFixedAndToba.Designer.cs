...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220320072311_SMSFixedAndToba")]
    partial class SMSFixedAndToba
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("1f5c9c0f-aacb-41bf-8456-42175637ec5d"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("f75cb936-6e8b-426d-9cc1-c20d6d1877ae"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("6bcf9e88-328e-4505-9e80-019a940ddbd0"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("204ac40d-ef82-4c87-976a-b864cec56503"),
                            DateCreated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(5916),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(5932),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("e8da87c1-4c8a-4467-88a8-64132140d3fb"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6217),
                            DateUpdated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6217),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e0566ddb-c0e6-429b-8d9a-862b43391d60"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6221),
                            DateUpdated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6221),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("d022944c-6b86-4dc2-b2ce-6c3d7fb031be"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6223),
                            DateUpdated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6224),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("541069a3-31f6-4d2b-b252-97b12ebf9129"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6225),
                            DateUpdated = new DateTime(2022, 3, 20, 8, 23, 8, 169, DateTimeKind.Local).AddTicks(6226),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
