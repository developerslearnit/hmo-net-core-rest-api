...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220116144538_Referral_requests_entities_two")]
    partial class Referral_requests_entities_two
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("4800fae2-3cfe-4719-995d-8fa06f8bb58a"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("1a1aa2ce-39ea-4f99-9f54-ff09e303172f"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("ac574f7c-6bab-44df-83b3-41bd01794c7f"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("0d64b762-6588-4887-bdc5-4169b6b5783e"),
                            DateCreated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1080),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1094),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("198464ed-14b4-48ba-baff-f7cd6a4a0289"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1323),
                            DateUpdated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1324),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("692177db-a075-4d63-9654-4195168bde10"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1328),
                            DateUpdated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1329),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a5007cd4-9c03-4f95-8023-c7436a79df7f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1332),
                            DateUpdated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1332),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("67885dab-c0fc-444d-b8f6-31e74d559adb"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1335),
                            DateUpdated = new DateTime(2022, 1, 16, 15, 45, 37, 155, DateTimeKind.Local).AddTicks(1336),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
