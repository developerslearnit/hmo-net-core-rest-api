...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220310103930_Toba_10-03-2022")]
    partial class Toba_10032022
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("ef1a831f-3bc0-4c8c-8dfc-b1ba6999b0b7"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("5b1f9835-c7e1-4958-9ea1-25ebd106b10f"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("64322801-fea4-4bc4-ac4a-ff98f1440578"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("b1c1efc6-d601-43ae-8424-2e7e3beba06e"),
                            DateCreated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9586),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9603),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("d63e516e-0870-42d0-87c5-574141e3a993"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9789),
                            DateUpdated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9789),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("1e692ecc-e441-4bca-a00a-49c2c78bd920"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9792),
                            DateUpdated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9793),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6c10f122-15ec-4640-bfe3-4fb35424c103"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9794),
                            DateUpdated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9795),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("fc69a6b5-5e1e-49d8-a85a-23e35b182c92"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9796),
                            DateUpdated = new DateTime(2022, 3, 10, 11, 39, 28, 194, DateTimeKind.Local).AddTicks(9797),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
