...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220222082057_added_mnotificationlog")]
    partial class added_mnotificationlog
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("f2d3401d-6346-4e5e-9f17-a9fd50e62af7"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("5349450b-bb53-4f9d-959f-c72edf0e10e6"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("534f313a-6de9-40cc-9139-49dabdea4217"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("da054d90-696d-4775-bd01-23ff0f82394b"),
                            DateCreated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(5795),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(5811),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("f7795c38-afab-43d4-b0c2-909f9a3c9ab8"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6002),
                            DateUpdated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6003),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ceadac15-9fc3-4a0c-918e-3ac0d23a5677"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6005),
                            DateUpdated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6005),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("4aed7226-4697-466e-83f8-b85a3c02452b"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6020),
                            DateUpdated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6020),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("491300b0-5586-4aa5-81af-600ebd726ff5"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6022),
                            DateUpdated = new DateTime(2022, 2, 22, 9, 20, 56, 737, DateTimeKind.Local).AddTicks(6022),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
