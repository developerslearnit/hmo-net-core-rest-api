...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220313103428_AppUserUpdate")]
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("424bf998-cc48-410b-aec4-eae55bf680d8"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("a124cbbe-1b8f-4e4e-90cc-2dcd6b812b78"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("91093443-6cad-4ec0-bf65-2056dddc246b"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("c7211a33-c196-49e7-bb6b-af0a57899021"),
                            DateCreated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4337),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4358),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("19b70078-d775-474f-b55e-13dff1fb5cbe"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4517),
                            DateUpdated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4517),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("199df182-8751-4cf5-9518-cc02f2882c01"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4520),
                            DateUpdated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4520),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("2f42db38-82b7-4a42-9a57-8d48b297b496"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4727),
                            DateUpdated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4728),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("17d57920-3917-4935-8451-7eff52689cfe"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4729),
                            DateUpdated = new DateTime(2022, 3, 13, 11, 34, 26, 598, DateTimeKind.Local).AddTicks(4730),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
