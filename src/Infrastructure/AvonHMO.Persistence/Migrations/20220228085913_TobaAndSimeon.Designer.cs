...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220228085913_TobaAndSimeon")]
    partial class TobaAndSimeon
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("840fe704-de26-4a8f-aba9-63d38017a5b2"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("45c82230-d129-4f82-9ebf-08fa9c72c185"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("ef09eca0-1915-411e-b793-56ce89de44ca"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("34de5654-b7d6-4d4c-829a-29de20d69f41"),
                            DateCreated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7819),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7833),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("8f0897ee-5edf-44c3-935f-ef5316b1b7da"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7987),
                            DateUpdated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7987),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3428b331-6288-46bb-a6f1-4606afb1e6d9"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7990),
                            DateUpdated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7990),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("958b0744-3064-4126-b7cd-468339b1521d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7992),
                            DateUpdated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7992),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("571d0c13-3cc2-4286-9bbb-acb21c78fe31"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7993),
                            DateUpdated = new DateTime(2022, 2, 28, 9, 59, 11, 790, DateTimeKind.Local).AddTicks(7994),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
