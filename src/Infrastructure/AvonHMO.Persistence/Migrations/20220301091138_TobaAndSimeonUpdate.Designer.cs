...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220301091138_TobaAndSimeonUpdate")]
    partial class TobaAndSimeonUpdate
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("b8e5e581-502a-4945-beca-8dba6c18a08b"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("b688417c-e387-4e0e-a0f8-7a8038779eea"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("c8069ad9-898a-4a00-bf6c-8f0a4aa43411"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("f6725edc-8bf3-49b6-8051-c32fb2e04589"),
                            DateCreated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3174),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3191),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("9eb77eb5-255d-4291-93e2-013cb0b929b6"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3353),
                            DateUpdated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3353),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("889d9ba4-e436-428d-9bc5-2398cc082620"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3356),
                            DateUpdated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3356),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ac1a8fce-fe13-4346-8248-6900e99e0e9b"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3358),
                            DateUpdated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3358),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7125b6cb-0e14-4226-abd1-cb897ebae4e1"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3369),
                            DateUpdated = new DateTime(2022, 3, 1, 10, 11, 37, 158, DateTimeKind.Local).AddTicks(3370),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
