...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220110162951_AddedPlanMapEntities")]
    partial class AddedPlanMapEntities
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("55169977-5671-44b8-97cc-6ff1f5d19b85"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("81b1fa24-fbdb-44b1-a154-c29b013e4ba3"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("099643b7-50f4-479f-9d32-cd93f18da1a7"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("da23f1fd-3020-4bed-8239-adf40adfab8b"),
                            DateCreated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(5844),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(5857),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("4749b3a9-47c1-46ea-9335-536ded0caac3"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(5994),
                            DateUpdated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(5994),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7e6267c0-24fa-4c79-aba3-38b890674380"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(5997),
                            DateUpdated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(5997),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("bda27973-1042-4c5b-952d-d1cfd8cbe248"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(5999),
                            DateUpdated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(6000),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e0719854-6bd9-4524-9d6a-24b50b16e20f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(6011),
                            DateUpdated = new DateTime(2022, 1, 10, 17, 29, 51, 256, DateTimeKind.Local).AddTicks(6012),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
