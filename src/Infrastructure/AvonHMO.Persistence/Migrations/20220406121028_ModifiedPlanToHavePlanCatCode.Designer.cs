...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220406121028_ModifiedPlanToHavePlanCatCode")]
    partial class ModifiedPlanToHavePlanCatCode
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("ecba183c-cd9e-47b6-b9a0-cd37211de7c5"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("6af1c353-412e-4903-ba4f-c67a023a4de3"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("9cb5549e-3520-4370-8074-c81b3d321a8d"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("89b2a130-90c6-4b62-b48e-6ab00712d42c"),
                            DateCreated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(888),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(908),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("733c3831-c0e0-4c59-a18a-cbc4475ec620"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1074),
                            DateUpdated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1075),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("74553af6-db7e-4892-93e5-8bcb4455dc4f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1077),
                            DateUpdated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1077),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("2c007067-3d6f-490b-bd8f-3c486593f796"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1079),
                            DateUpdated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1079),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("8a2718af-6fca-499c-a4aa-1ccb72b1f5d1"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1095),
                            DateUpdated = new DateTime(2022, 4, 6, 13, 10, 26, 774, DateTimeKind.Local).AddTicks(1095),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
