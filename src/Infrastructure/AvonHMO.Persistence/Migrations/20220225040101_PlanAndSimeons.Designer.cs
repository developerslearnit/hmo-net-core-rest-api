...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220225040101_PlanAndSimeons")]
    partial class PlanAndSimeons
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("18ab063d-b7fc-4a19-96bd-28237e90b087"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("0006d263-9165-4579-b2e1-0ac61be60246"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("edf4675b-82e9-4439-af3b-908212ac3370"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("2bc950b1-fde8-463b-8a8c-50762636a340"),
                            DateCreated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3826),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3839),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("2d7249c3-27b8-4723-95db-02774a3d5d8e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3964),
                            DateUpdated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3965),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a4e5a6de-35d7-4b7b-b984-65bdbdc68ae2"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3967),
                            DateUpdated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3968),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ce715dc0-d3b7-4eb8-82c6-c8cbd190d173"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3970),
                            DateUpdated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3970),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("010ea7c9-d554-4a4f-a64c-a4ec670da17d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3971),
                            DateUpdated = new DateTime(2022, 2, 25, 5, 0, 59, 800, DateTimeKind.Local).AddTicks(3972),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
