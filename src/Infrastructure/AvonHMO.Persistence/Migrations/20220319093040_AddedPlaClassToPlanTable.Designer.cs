...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220319093040_AddedPlaClassToPlanTable")]
    partial class AddedPlaClassToPlanTable
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("b4c370fb-f961-4c30-b9c7-15da29b25fb7"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("5eb6b797-d1d0-40c0-80fa-b5949f777dc9"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("91bac9cc-aef0-42a9-a1c9-5be9ea0ac053"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("5ad99ed6-c841-4924-8b23-54477882d033"),
                            DateCreated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5459),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5475),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("8530938b-f1d7-49fe-87a9-c3ca3f3c00e0"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5625),
                            DateUpdated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5625),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("1f13a824-bbbe-4832-9d55-fdc6db60b9c2"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5627),
                            DateUpdated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5628),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("f392faaf-c75b-4064-9518-dd9ca2861143"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5641),
                            DateUpdated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5642),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("b87a490e-d7ae-4e2e-8115-1b8a2728fe70"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5643),
                            DateUpdated = new DateTime(2022, 3, 19, 10, 30, 38, 140, DateTimeKind.Local).AddTicks(5644),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
