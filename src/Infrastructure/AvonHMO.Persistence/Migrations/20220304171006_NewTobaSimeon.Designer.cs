...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220304171006_NewTobaSimeon")]
    partial class NewTobaSimeon
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("4e226a42-869e-48ad-bc8c-0792345f4397"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("cad8649f-9af0-473f-af9a-742036ef0ee4"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("4514840f-e09e-4372-8f3c-0371b9371303"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("8f7b9bf5-47cd-4668-93c0-c267acf828c4"),
                            DateCreated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7372),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7387),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("c19e0863-b3cb-4d4e-b779-405452707f5c"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7558),
                            DateUpdated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7558),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("1457899d-d3e2-40ea-96c9-fa8cb5bb0f25"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7561),
                            DateUpdated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7561),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("68e68d1e-e9bf-41cd-9219-84795ae5251e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7563),
                            DateUpdated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7563),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6d8b7385-800c-4918-b237-9871f1dfb8e1"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7564),
                            DateUpdated = new DateTime(2022, 3, 4, 18, 10, 4, 630, DateTimeKind.Local).AddTicks(7565),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
