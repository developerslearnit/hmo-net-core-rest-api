...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220219174608_ClaimsRepo")]
    partial class ClaimsRepo
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("da4cfdde-ccda-4be7-9200-c417e0e13458"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("17ed906d-b5fc-4520-b9be-3a2f6145524e"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("8af6b573-c5f2-42cd-a365-5b7ddd640a9c"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("080c8c96-9c6e-49ac-9737-ce4f12c13314"),
                            DateCreated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(2971),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(2987),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("e2869f78-99d2-4baf-ba0b-bc98117b6d1e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3122),
                            DateUpdated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3123),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6f90e5b9-cf21-4474-9a74-8e1e225293f6"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3126),
                            DateUpdated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3127),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a887bc49-0ac0-46b6-8d61-b5213a480c63"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3129),
                            DateUpdated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3129),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("78c9ab33-2c4e-48cb-9bcd-cacfb9de31d8"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3131),
                            DateUpdated = new DateTime(2022, 2, 19, 18, 46, 7, 565, DateTimeKind.Local).AddTicks(3131),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
