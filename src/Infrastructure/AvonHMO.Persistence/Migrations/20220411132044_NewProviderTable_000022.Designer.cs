...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220411132044_NewProviderTable_000022")]
    partial class NewProviderTable_000022
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("606d8422-6f64-4f2f-b635-7b47046e6f95"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("b3019d79-f86e-4003-838f-f9f6344aab9c"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("94761f60-a127-4e33-a0f5-1f6454697b46"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("720a4f26-7251-46b5-a221-20490d8b1bb0"),
                            DateCreated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8509),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8531),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Plan", b =>
                {
                    ...
                    b.Property<int>("PlanCategoryCode")
                        .HasColumnType("int");

                    b.Property<string>("PlanClass")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("AvonHMO.Entities.Provider", b =>
                {
                    ...
                    b.Property<string>("DoctorCoverageHour")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("HMOOfficerGSM")
                        .IsRequired()
                        .HasMaxLength(25)
                    ...
                    b.Property<string>("ProviderOperationDay")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("ProviderOperationHour")
                        .HasMaxLength(510)
                        .HasColumnType("nvarchar(510)");
            ...
            modelBuilder.Entity("AvonHMO.Entities.ProviderChangeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<DateTime>("NextPossibleChangeDate")
                        .HasColumnType("datetime2");

                    b.HasKey("Id");

                    b.ToTable("ProviderChangeLogs");
                });
            ...
            modelBuilder.Entity("AvonHMO.Entities.ReferralRequest", b =>
                {
                    b.Property<Guid>("ReferralRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.Property<string>("ReferralTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AvonHMO.Entities.RequestAuthorization", b =>
                {
                    ...
                    b.Property<string>("AvonEnrolleId")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("fb19151b-5f7a-480b-a46e-3cd5e0c69693"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8766),
                            DateUpdated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8767),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ec399131-e73f-4a66-b0cc-1e6981fadf90"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8769),
                            DateUpdated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8770),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("4357dfa8-ce79-4ca3-b8af-3897321bfa4d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8772),
                            DateUpdated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8772),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6ca401b2-9928-4468-9d48-b3b9b293fed7"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8774),
                            DateUpdated = new DateTime(2022, 4, 11, 14, 20, 42, 622, DateTimeKind.Local).AddTicks(8774),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
            ...
            modelBuilder.Entity("AvonHMO.Entities.Temp_Enrollee", b =>
                {
                    b.Property<Guid>("Temp_EnrolleeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.Property<string>("OrderPaymentRefrence")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("Temp_EnrolleeId");

                    b.ToTable("Temp_Enrollee", (string)null);
                });
