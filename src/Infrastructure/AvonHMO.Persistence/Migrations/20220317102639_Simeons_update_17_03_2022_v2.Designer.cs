...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220317102639_Simeons_update_17_03_2022_v2")]
    partial class Simeons_update_17_03_2022_v2
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("bc137cff-e873-45b5-a2f1-5b62b795be87"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("0c66d504-7f9f-46a3-8fbb-45b85e66f9f3"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("e4134b10-8022-4a4e-a927-f8f81145fa7d"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("2f8c1c85-54b9-4ac9-9e7f-85377fa55345"),
                            DateCreated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9759),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9775),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("7d8be949-8076-4dce-b7fb-9a0eff82986f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9928),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9929),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("24e99a62-86f8-48ad-8b95-0e9b0f26169f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9931),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9931),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("383f9f95-c0b1-47a8-a7db-92ea3322ea2a"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9943),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9944),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("cc09bcbd-0afc-4030-954b-ad8ec6200435"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9945),
                            DateUpdated = new DateTime(2022, 3, 17, 11, 26, 37, 521, DateTimeKind.Local).AddTicks(9946),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
