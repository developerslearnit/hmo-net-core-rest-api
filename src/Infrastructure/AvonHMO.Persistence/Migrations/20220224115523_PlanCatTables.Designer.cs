...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220224115523_PlanCatTables")]
    partial class PlanCatTables
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("f35b79d5-8e6e-44f6-bb1a-1671b55b7c84"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("212f1995-264d-48e1-995e-4bebf30d0f71"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("70930e7e-ced8-4d98-9983-fa6535438dcf"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("28847881-71a6-4ded-bccd-d15f289a24e2"),
                            DateCreated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3061),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3075),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("fb02b4e3-b350-4d9f-862a-367fdecf382a"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3243),
                            DateUpdated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3243),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("45f9d95c-d2dc-4671-9523-739b2c13c29d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3245),
                            DateUpdated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3246),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3c0dae74-a25c-4c6c-830b-666c7f35ca0f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3248),
                            DateUpdated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3248),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("66675121-6c96-4fb0-83f6-5088c7b6708b"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3249),
                            DateUpdated = new DateTime(2022, 2, 24, 12, 55, 21, 857, DateTimeKind.Local).AddTicks(3250),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
