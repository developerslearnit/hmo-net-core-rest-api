...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220301205000_SimeonUpdate")]
    partial class SimeonUpdate
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("ecc741f1-f1b2-43c6-abac-5bc001389369"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("6185c107-51fd-4f67-a97a-04228e496eed"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("a00f20ac-daa7-4e79-b7f2-4cec51c77ef7"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("6d4a71d8-23b2-494c-839b-0e6736e9b366"),
                            DateCreated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(7892),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(7908),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("8db3be97-249b-42dd-9ea0-7e763353df0d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8243),
                            DateUpdated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8243),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("05c65caf-3bb4-456f-804e-812cf8b26969"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8246),
                            DateUpdated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8246),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("de18c9b1-dcea-4208-a2ab-d7932fdeb49b"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8248),
                            DateUpdated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8248),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("dd16fac1-9746-4794-a5d3-5176adb7af96"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8260),
                            DateUpdated = new DateTime(2022, 3, 1, 21, 49, 58, 680, DateTimeKind.Local).AddTicks(8260),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
