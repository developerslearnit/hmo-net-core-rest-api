...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220319155010_AddedReferalRequest")]
    partial class AddedReferalRequest
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("dbbf4dc7-e72f-49f0-9517-c0b612163b46"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("8aba0210-1a5b-4d20-ad60-fed825c42087"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("067e32a7-f30d-4c40-a798-63285480bc9d"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("fa40c922-3c7d-459d-b0ba-f5c230d85d34"),
                            DateCreated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2709),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2725),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("8ccab78c-9aa9-419d-ae6c-3b02c72c24fe"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2898),
                            DateUpdated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2898),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("1ee23e8d-1a1d-45dc-8ed0-77ed1cdeea59"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2901),
                            DateUpdated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2901),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("c366ac30-86c0-4d01-991d-da2bddb0d10f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2903),
                            DateUpdated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2903),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("8fcd61d2-6d40-4373-8d30-605081dd2137"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2904),
                            DateUpdated = new DateTime(2022, 3, 19, 16, 50, 8, 488, DateTimeKind.Local).AddTicks(2905),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
