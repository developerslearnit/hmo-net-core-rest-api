...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220122165103_TobaBuild")]
    partial class TobaBuild
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("d58c4268-d06f-4969-8b1c-a1ac3443d5af"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("4ddfc850-18ff-4124-b515-7aac6b65ac79"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("d7301a77-8c1b-4b3b-990a-c6363130e1fb"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("7bfb1d00-ea82-47f1-8e08-7d78758eedb0"),
                            DateCreated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9592),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9607),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("6faade26-fdf4-416c-bfc1-3e1e82d93b84"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9850),
                            DateUpdated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9851),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("4f42136e-78ab-4c1c-83d5-7eab78498c7b"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9853),
                            DateUpdated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9854),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e76d51af-3a73-45d5-b61e-9d0db1b679c8"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9856),
                            DateUpdated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9856),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("532bc8a2-59cc-4c89-8488-2b646152f805"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9871),
                            DateUpdated = new DateTime(2022, 1, 22, 17, 51, 2, 456, DateTimeKind.Local).AddTicks(9871),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
