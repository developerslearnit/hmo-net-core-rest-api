...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220311114328_AddedProviderPlanMap")]
    partial class AddedProviderPlanMap
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("ce8a65d8-9d76-4e1e-8f25-076eb82ec8eb"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("8a516de1-9d7b-4d1a-846c-3024ce73f5dc"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("fc15f91c-6d3c-4221-bca2-fb91163fa9f3"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("542ee22e-9ac2-4244-8ffb-73f530fa4fe2"),
                            DateCreated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(1879),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(1895),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("1cad8626-fec6-4088-8dfb-b69b2051cb3a"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2080),
                            DateUpdated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2080),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("347bad39-afd8-4ecc-b24a-0e468facfc2f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2082),
                            DateUpdated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2083),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("55aa5cec-38ea-427d-aa30-159ba7f19dbf"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2084),
                            DateUpdated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2085),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("df0f7184-2e70-44c2-a3ff-ab031721131d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2086),
                            DateUpdated = new DateTime(2022, 3, 11, 12, 43, 26, 571, DateTimeKind.Local).AddTicks(2087),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
