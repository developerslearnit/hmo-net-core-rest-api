...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220113150032_MarkedAddressAndEmailOptional")]
    partial class MarkedAddressAndEmailOptional
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("742be0ce-2e19-4cd3-b330-24d736e421b8"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("aa03601b-7c37-4d1f-a6ba-b66d7436caf5"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("b685780c-b212-43cd-87ef-958f2645d7f5"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("231fb3d5-4b11-4e82-9020-8d3f644bbe8d"),
                            DateCreated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6080),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6095),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("4777626f-019e-463e-b381-2018a8cc6b11"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6294),
                            DateUpdated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6294),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("60e5d814-64c8-4434-8adb-8d3c2ecc5064"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6297),
                            DateUpdated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6297),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("d378131d-87a8-4a34-a249-354c9d0ae5ad"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6299),
                            DateUpdated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6300),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7dd50bb9-7c6d-48ff-ac4d-26e8608253da"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6302),
                            DateUpdated = new DateTime(2022, 1, 13, 16, 0, 32, 547, DateTimeKind.Local).AddTicks(6302),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
