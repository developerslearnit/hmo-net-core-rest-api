...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220224142337_Simeons")]
    partial class Simeons
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("c6bd86da-ddb7-4b9b-9d00-c4a77b007637"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("a24b4f46-d0c3-4e3b-958d-212493668424"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("79422d55-75ac-4241-8b49-31bffbed9afe"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("c09f09a2-f1b1-480f-8fb5-81ea4f1fbcb8"),
                            DateCreated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9607),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9622),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("fdcced39-e2f6-41f5-a286-384def96e02d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9724),
                            DateUpdated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9724),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("dca66c64-da8b-40b9-b8af-bb65bdfdd092"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9727),
                            DateUpdated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9727),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7dfcca04-e52e-4f8e-a0e5-cfcfdc2ecce4"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9729),
                            DateUpdated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9729),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("b716fdc7-5433-49f7-87aa-759b608669d7"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9731),
                            DateUpdated = new DateTime(2022, 2, 24, 15, 23, 36, 372, DateTimeKind.Local).AddTicks(9731),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
