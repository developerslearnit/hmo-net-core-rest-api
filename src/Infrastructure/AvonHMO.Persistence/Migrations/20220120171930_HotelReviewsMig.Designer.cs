...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220120171930_HotelReviewsMig")]
    partial class HotelReviewsMig
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("95a79c56-f993-4202-8447-27542a82e714"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("58b9d881-2db2-4ba4-a7ec-3703caf4af50"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("b07dc440-92cb-4063-aa7a-a645548779a2"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("1630825d-6113-4ba2-b9af-961b1f32d467"),
                            DateCreated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3508),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3520),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("fdf8699e-12d7-4b1c-9c58-11c7782ceed9"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3764),
                            DateUpdated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3764),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("5ce69e06-1939-465b-ad28-2dab98d4e62c"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3767),
                            DateUpdated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3768),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("631485e1-2a60-4414-9dd8-e5211a283588"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3782),
                            DateUpdated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3782),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("5896afd0-7aa4-4bfb-ab93-f92bd8753c96"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3784),
                            DateUpdated = new DateTime(2022, 1, 20, 18, 19, 30, 35, DateTimeKind.Local).AddTicks(3785),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
