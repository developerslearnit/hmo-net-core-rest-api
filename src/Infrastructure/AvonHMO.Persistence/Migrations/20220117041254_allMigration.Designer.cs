...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220117041254_allMigration")]
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("de0c2d37-b106-42c9-9aa6-f7197974ab02"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("afb4f2e2-bd3e-40fa-9a6f-7a93f24eec2d"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("304d4f9f-4094-43f6-807a-319bcffc2465"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("410baa55-7cf3-44ce-a4e2-25770d93d285"),
                            DateCreated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2126),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2141),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("ac960b54-8888-4e72-8e2c-9b27f512a777"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2393),
                            DateUpdated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2393),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("83fa1fc9-1411-43ab-aa34-cf2f0346f3c4"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2411),
                            DateUpdated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2411),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("d046a357-7463-42f1-a9e8-3c8c127bb2ee"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2414),
                            DateUpdated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2414),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("0f38eb4b-bf12-42f5-9d6d-6813e5d66e26"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2416),
                            DateUpdated = new DateTime(2022, 1, 17, 5, 12, 54, 547, DateTimeKind.Local).AddTicks(2417),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
