...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220222092911_added_faq")]
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("f97fe7a9-0d8c-43ab-9c4f-4fc02377bf6f"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("003b0f7c-c043-47bc-a3e2-5dc2c4101c1a"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("1311bafc-833c-40cb-85ee-17cf2cdc698c"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("05d6c516-3125-499e-a14c-e7d8f36a44d8"),
                            DateCreated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8195),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8210),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("3829f706-8cab-4dd4-a48e-c0c7c3d74889"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8341),
                            DateUpdated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8341),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("529c1d28-3b68-4293-a0b1-03a15497e027"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8343),
                            DateUpdated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8344),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("da3ec04d-9e86-425d-8f44-2c57a766ba6f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8345),
                            DateUpdated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8346),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("aef159ee-cf0e-4697-83c9-ace7e5d3e8db"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8347),
                            DateUpdated = new DateTime(2022, 2, 22, 10, 29, 9, 865, DateTimeKind.Local).AddTicks(8347),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
