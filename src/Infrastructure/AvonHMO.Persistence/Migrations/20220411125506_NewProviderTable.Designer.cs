...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220411125506_NewProviderTable")]
    partial class NewProviderTable
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("1ab54cae-312d-422a-a0cb-d34cc0a04bf5"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("9a7753fb-60f3-43ca-987b-8e31f2fa2b8d"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("0a29397a-6adc-4b6f-8510-bd553a93c87f"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("f8e89226-ed86-43a4-851a-9a585788bb9a"),
                            DateCreated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4599),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4618),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("a1832e21-a74d-4320-b696-eadc2f2d99e1"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4810),
                            DateUpdated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4810),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("5718021d-6186-48ee-9ade-0a4bfeff8e41"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4812),
                            DateUpdated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4812),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3e93b8a4-0b80-4a95-9595-14c30a7b0b3c"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4814),
                            DateUpdated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4815),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6f7a9c3c-d660-4cdb-88c6-637d3c65336b"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4836),
                            DateUpdated = new DateTime(2022, 4, 11, 13, 55, 5, 539, DateTimeKind.Local).AddTicks(4836),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
