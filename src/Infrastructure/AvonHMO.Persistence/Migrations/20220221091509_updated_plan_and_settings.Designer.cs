...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220221091509_updated_plan_and_settings")]
    partial class updated_plan_and_settings
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("85879fda-1210-400b-99db-b59fff6a1e3a"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("a666e372-4433-463b-8857-e4fe5a1e53fd"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("668a6c16-c84b-4ed4-8b72-a7dc3e639dc2"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("884e5733-37a5-4a33-95a4-41b10b8080e3"),
                            DateCreated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(882),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(904),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("edd75853-6aa0-4f81-bfbf-ac718f6a5926"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1065),
                            DateUpdated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1066),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("bf5a90ea-235b-4160-9a8c-79f469f8bc1d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1069),
                            DateUpdated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1069),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("28a60aa2-3e82-4831-892e-ae8b945b7416"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1071),
                            DateUpdated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1071),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("c3c48935-bf85-46dd-bb5d-ba7b5fe329b8"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1073),
                            DateUpdated = new DateTime(2022, 2, 21, 10, 15, 8, 110, DateTimeKind.Local).AddTicks(1073),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
