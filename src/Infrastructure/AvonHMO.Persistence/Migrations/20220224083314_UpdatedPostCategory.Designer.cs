...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220224083314_UpdatedPostCategory")]
    partial class UpdatedPostCategory
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("a0536426-c284-40bd-b9fd-73048a7407f1"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("6c19b62b-808c-4c3e-b172-9dc0772db407"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("cc01c3b4-9153-4a06-9822-584d862693b2"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("0e2ff7d3-76d0-4159-9b38-8d07a8c11592"),
                            DateCreated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9359),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9377),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("1f5b67ab-5a8d-42f3-a166-9c4fc0297744"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9539),
                            DateUpdated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9539),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ac803d7a-bbc4-4d02-bdd9-13cb26e32f54"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9541),
                            DateUpdated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9542),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("42dca732-0720-4e13-a9cd-e1199ad914ab"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9544),
                            DateUpdated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9544),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("e3dc5bf4-f296-4dd9-ac9e-b5ee6e081b0d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9546),
                            DateUpdated = new DateTime(2022, 2, 24, 9, 33, 13, 292, DateTimeKind.Local).AddTicks(9546),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
