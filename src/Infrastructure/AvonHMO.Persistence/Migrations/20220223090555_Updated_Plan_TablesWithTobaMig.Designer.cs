...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220223090555_Updated_Plan_TablesWithTobaMig")]
    partial class Updated_Plan_TablesWithTobaMig
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("6fe6640a-b56f-468d-8b5d-01a6696c843b"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("7126e5ff-571e-4809-9686-3baf6663b266"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("7763f76f-7670-4a64-9f32-b9ee3f1ddf23"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("5abbd6d4-c155-4be2-aac6-9c16bdb22c94"),
                            DateCreated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3489),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3504),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("012b1907-5f03-41e7-9a21-bc9e407314c8"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3702),
                            DateUpdated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3702),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("18e00eec-827f-4685-80ff-b3f57c71b31b"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3707),
                            DateUpdated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3707),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("828ba59e-3e7a-4a10-82f6-41eedd29a529"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3710),
                            DateUpdated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3710),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("bd35f495-2904-4658-b166-54fc3082b707"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3712),
                            DateUpdated = new DateTime(2022, 2, 23, 10, 5, 53, 258, DateTimeKind.Local).AddTicks(3713),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
