...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220113130200_SubscribeTable")]
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("513e9d9d-7111-43e4-a708-6fcbed4acf63"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("96fdbe89-3aaa-4f44-8f5f-a22e3aca6e82"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("7460d9c5-f53b-465b-b394-aab15d75f297"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("c14d038b-da79-48f9-a551-50fd90a9c5f4"),
                            DateCreated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1717),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1730),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("0b966135-e99b-495a-911b-e3999d0f2b1e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1858),
                            DateUpdated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1859),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3b454e0f-6c1e-4cea-8f31-6fb7bc06bf45"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1861),
                            DateUpdated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1862),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("8adf7bca-ecdd-4728-b6c8-e9d991d15e45"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1864),
                            DateUpdated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1864),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3c51ddf9-0dad-454c-a469-1d45c879483e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1866),
                            DateUpdated = new DateTime(2022, 1, 13, 14, 1, 59, 707, DateTimeKind.Local).AddTicks(1866),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
