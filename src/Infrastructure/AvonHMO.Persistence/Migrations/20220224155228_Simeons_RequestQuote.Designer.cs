...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220224155228_Simeons_RequestQuote")]
    partial class Simeons_RequestQuote
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("461d287d-8715-463f-a700-3d521acf5178"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("7d797270-98b5-4614-9339-c1305ba456e3"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("ac99f398-33db-475b-96ca-970c7806249a"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("5cc033ae-cb3b-48b4-9572-756ef5a14e45"),
                            DateCreated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(1830),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(1850),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("a1e8e5df-4c7e-45d0-ab43-84439a66e307"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2094),
                            DateUpdated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2095),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("3f24dbdc-9bbe-4435-bd2a-6f2301281b75"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2098),
                            DateUpdated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2098),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("4800990f-be2d-43c8-8db9-00dcdc20ead2"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2100),
                            DateUpdated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2100),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ef04ec8a-330a-42e7-a015-ae81e6026ac4"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2102),
                            DateUpdated = new DateTime(2022, 2, 24, 16, 52, 26, 744, DateTimeKind.Local).AddTicks(2103),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
