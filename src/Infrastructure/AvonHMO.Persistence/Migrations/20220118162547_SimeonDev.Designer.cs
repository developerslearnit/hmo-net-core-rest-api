...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220118162547_SimeonDev")]
    partial class SimeonDev
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("ed80ef2e-5d0a-4f0e-8e30-bfc4821ab25d"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("6a83f533-eee4-44f8-9d1c-6c67e55c2635"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("f9ec6a4f-4dc6-4442-959d-c08b9588177f"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("a2ddc022-7316-48c5-aa15-5d3e679e384f"),
                            DateCreated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(3856),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(3870),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("a8c67338-d8b9-4e1b-bb19-df7ff0b47a25"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4006),
                            DateUpdated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4006),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("06a5a625-aa15-4ffe-be87-2b61f740dff8"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4009),
                            DateUpdated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4010),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("9043d2a8-776e-4d2d-aa68-b2a49c031804"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4012),
                            DateUpdated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4012),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("1d772b53-1650-4d49-ac3c-f937152583cb"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4014),
                            DateUpdated = new DateTime(2022, 1, 18, 17, 25, 46, 468, DateTimeKind.Local).AddTicks(4014),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
