...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220304062025_NewTobaSim")]
    partial class NewTobaSim
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("2b401405-62eb-4a99-94eb-24b43ecf6cdb"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("70c86bd5-ba65-4675-9804-3aa4fee6e5b6"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("6329e149-583c-4d5a-a7d2-43a4d1cf8e6d"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("5690ec7f-ab77-43dc-92ec-f802622e212a"),
                            DateCreated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8324),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8338),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("83278ebc-4990-4575-85e2-1c15f06dd674"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8508),
                            DateUpdated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8509),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("0c8e62d4-0ee8-4f80-a424-59dd7f4f9aef"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8511),
                            DateUpdated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8512),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("bd14553b-77ba-4e57-89da-94ca20558102"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8513),
                            DateUpdated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8514),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6473a924-c527-417b-87ab-18e68a087463"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8515),
                            DateUpdated = new DateTime(2022, 3, 4, 7, 20, 24, 15, DateTimeKind.Local).AddTicks(8515),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
