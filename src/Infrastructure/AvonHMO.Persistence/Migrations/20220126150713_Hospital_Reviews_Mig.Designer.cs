...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220126150713_Hospital_Reviews_Mig")]
    partial class Hospital_Reviews_Mig
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("3d99bd18-1379-41a5-96c2-2f4996eaf2c1"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("3512689e-588e-426c-a4f5-17d8175d6676"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("958d5a6f-e98c-45e9-904d-aeb7c079bac6"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("fe57c044-c963-4c6c-8dfc-bc103965ec9c"),
                            DateCreated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1165),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1180),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("e4b7c59b-0384-4cc1-95f3-c2d52501b3b1"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1307),
                            DateUpdated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1307),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("fb47afd6-125e-405c-a768-77485920473a"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1309),
                            DateUpdated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1310),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("85e1827f-f3c7-46bc-b5c7-bb8fc6dc691a"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1322),
                            DateUpdated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1322),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("8e78a081-ab36-4031-bb97-f8fced91fbf9"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1324),
                            DateUpdated = new DateTime(2022, 1, 26, 16, 7, 12, 706, DateTimeKind.Local).AddTicks(1324),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
