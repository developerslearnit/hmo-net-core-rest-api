...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220426090410_ThurbahUpdate")]
    partial class ThurbahUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AvonHMO.Entities.EmailLog", b =>
                {
                    ...
                    b.Property<bool>("SendSuccessfully")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("RequestReference")
                        .IsUnique()
                        .HasFilter("[RequestReference] IS NOT NULL");
            ...
            modelBuilder.Entity("AvonHMO.Entities.EnrolleeComplaint", b =>
                {
                    b.Property<Guid>("EnrolleeComplaintId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.HasKey("EnrolleeComplaintId");

                    b.ToTable("EnrolleeComplaints");
                });

            modelBuilder.Entity("AvonHMO.Entities.EnrolleeComplaintAdminResponse", b =>
                {
                    b.Property<Guid>("EnrolleeComplaintAdminId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.HasKey("EnrolleeComplaintAdminId");

                    b.ToTable("EnrolleeComplaintAdminResponses");
                });
            ...
            modelBuilder.Entity("AvonHMO.Entities.EnrolleeRecommendation", b =>
                {
                    ...
                    b.Property<string>("RecommendationCategory")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("AvonHMO.Entities.HCPInspectionGuideOptions", b =>
                {
                    ...
                    b.ToTable("HCPInspectionGuildOptions");
                });

            modelBuilder.Entity("AvonHMO.Entities.HCPInspectionGuideQuestionMaster", b =>
                {
                    b.Property<Guid>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("HCPInspectionGuildQuestionMasters");
                });

            modelBuilder.Entity("AvonHMO.Entities.HCPInspectionGuildAnswer", b =>
                {
                    ...
                    b.ToTable("HCPInspectionGuildAnswers");
                });

            modelBuilder.Entity("AvonHMO.Entities.HCPManagerRequest", b =>
                {
            ...
            modelBuilder.Entity("AvonHMO.Entities.ProviderContractualDoc", b =>
                {
                    ...
                    b.ToTable("ProviderContractualDocs");
                });
            ...
            modelBuilder.Entity("AvonHMO.Entities.ProviderRating", b =>
                {
                    ...
                    b.Property<decimal>("EasyAccessingCare")
                        .HasMaxLength(50)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("AvonHMO.Entities.SubscriptionHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
