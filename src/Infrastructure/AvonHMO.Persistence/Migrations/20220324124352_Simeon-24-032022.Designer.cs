...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220324124352_Simeon-24-032022")]
    partial class Simeon24032022
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("8fa3ae5f-4363-4cee-959e-11d2ad447187"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("6dedc037-820d-4d30-b86f-4ba4caebf572"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("6a14c279-701a-47bc-9a7f-930043d60c8b"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("7c6d8f3e-d3f0-48c1-99a9-e1886809f593"),
                            DateCreated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7658),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7675),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("4f04c3d6-13c8-471f-b3e3-8f909f1668ac"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7924),
                            DateUpdated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7924),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("b7ce94e5-94ec-477d-b3da-a8970dfaf22c"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7926),
                            DateUpdated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7927),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("aca5cd67-fbdc-40f6-a0e4-26b0c90016fe"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7937),
                            DateUpdated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7937),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("2cbc216e-1c94-44b2-87d1-75471ed8b995"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7938),
                            DateUpdated = new DateTime(2022, 3, 24, 13, 43, 50, 901, DateTimeKind.Local).AddTicks(7939),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
