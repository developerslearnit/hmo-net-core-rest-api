...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220219103104_AddedCategoryTable_RemoveCatTable")]
    partial class AddedCategoryTable_RemoveCatTable
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("b4b9a366-5cbb-4aaf-aae0-647fe13cf912"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("8e7efa68-2476-47fc-b0e7-5f624a48ef94"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("d6caaf46-19cf-498c-a43b-9d24bb64de09"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("63192e21-15bc-44c9-bd32-e2dcb6219079"),
                            DateCreated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(7874),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(7887),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("8b6f1169-d2a8-45af-b486-d8ae1f06ddf6"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8046),
                            DateUpdated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8047),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("dca790ad-1ae2-478f-972a-97e7c6a3506d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8049),
                            DateUpdated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8049),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("9a2b7ded-8f4d-4784-984b-e5f6658696c2"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8051),
                            DateUpdated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8051),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("01652fd4-abb4-4048-805c-9bb9671b9950"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8053),
                            DateUpdated = new DateTime(2022, 2, 19, 11, 31, 4, 190, DateTimeKind.Local).AddTicks(8053),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
