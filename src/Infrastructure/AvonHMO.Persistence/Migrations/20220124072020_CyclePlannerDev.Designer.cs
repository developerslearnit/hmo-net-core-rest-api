...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220124072020_CyclePlannerDev")]
    partial class CyclePlannerDev
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("d8600b0c-2269-4478-a80f-b329a6b42f5a"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("605dd15d-54cf-46a8-84de-914e5cede5be"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("7ae7bee8-1e94-4603-91e2-a0d444d36a08"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("6b707a84-037d-47ad-b0e4-26dd8234f785"),
                            DateCreated = new DateTime(2022, 1, 24, 8, 20, 19, 956, DateTimeKind.Local).AddTicks(9976),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 24, 8, 20, 19, 956, DateTimeKind.Local).AddTicks(9991),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("3b7db63e-9e9e-4c5b-bd82-6a01af5aa51d"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(131),
                            DateUpdated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(132),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("61e95825-5ac1-46f9-a32e-561133d2224e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(134),
                            DateUpdated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(134),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("f93a3ef4-1618-4188-be70-3ff58981ada1"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(136),
                            DateUpdated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(136),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("33e76875-4fd2-41fe-89eb-8dbe64b0b770"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(137),
                            DateUpdated = new DateTime(2022, 1, 24, 8, 20, 19, 957, DateTimeKind.Local).AddTicks(138),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
