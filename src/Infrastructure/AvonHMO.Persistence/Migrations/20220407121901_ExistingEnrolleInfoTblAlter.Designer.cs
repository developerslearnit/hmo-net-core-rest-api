...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220407121901_ExistingEnrolleInfoTblAlter")]
    partial class ExistingEnrolleInfoTblAlter
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("205ba000-4dc0-4e0f-a08f-e66670299a7c"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("3c41f531-cfc7-4e4b-99c0-c07f8d9c1d4a"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("1022b648-4bf1-4d1a-906b-1614fe275604"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("edc01bc8-3e81-44f4-9fad-1e87f745ffa9"),
                            DateCreated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5532),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5551),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("e5f6295a-2a30-47b8-aeaa-f0acd15fda73"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5702),
                            DateUpdated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5702),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("bd628966-8189-4fbd-9738-a144326414c4"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5705),
                            DateUpdated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5705),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("80e0e983-2101-4db8-a763-f7f09e690837"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5707),
                            DateUpdated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5707),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("4d4db0ff-1488-435b-87ab-5d15a6980176"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5709),
                            DateUpdated = new DateTime(2022, 4, 7, 13, 19, 0, 241, DateTimeKind.Local).AddTicks(5710),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
