...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220302064606_SimeonUpdate02-03-2022")]
    partial class SimeonUpdate02032022
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("c559c977-e8a6-4c8b-a3e4-11b0bc2b7f23"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("77142cba-6064-4b84-955e-55315de0f003"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("d4a7e563-b5ef-40d5-b317-933b0d9c1278"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("65c5dbb9-3784-416c-884f-8a7efc9661b2"),
                            DateCreated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4296),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4312),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("7d7d3d79-1d6e-4756-83fd-38994bc03b23"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4440),
                            DateUpdated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4441),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("7abd7d75-b523-4dc7-ab5d-25ce0bcffc02"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4444),
                            DateUpdated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4444),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ca2fe0cf-bbda-489a-a1b8-14fecee42dde"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4446),
                            DateUpdated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4446),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("f612f77f-b181-4c1e-ba76-a36c1acb2b4e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4447),
                            DateUpdated = new DateTime(2022, 3, 2, 7, 46, 5, 173, DateTimeKind.Local).AddTicks(4448),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
