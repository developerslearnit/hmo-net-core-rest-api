...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220306131244_AddedAuditLog")]
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("8690a6ab-e592-4e6b-bf3a-c7b1f02831b0"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("258d2ef6-333f-42fa-a734-5590b7ca02b8"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("bf94593e-1a5b-406b-9e74-50f8f5bce66a"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("298946b8-150a-4e47-81a2-4b9ca9431d47"),
                            DateCreated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5310),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5324),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("96441b07-9ab4-4c19-a041-cbec00fe8c5c"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5436),
                            DateUpdated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5436),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("f4f43f76-81b9-437a-9ffa-7cbe867a2ce6"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5438),
                            DateUpdated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5438),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ff2d33be-e6ba-43d4-9c6b-c30e6d839c94"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5440),
                            DateUpdated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5440),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("8b3d203b-4add-425c-ad0c-9470f547a183"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5462),
                            DateUpdated = new DateTime(2022, 3, 6, 14, 12, 42, 857, DateTimeKind.Local).AddTicks(5463),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
