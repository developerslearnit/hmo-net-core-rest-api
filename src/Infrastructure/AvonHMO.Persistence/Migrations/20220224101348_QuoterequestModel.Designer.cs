...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220224101348_QuoterequestModel")]
    partial class QuoterequestModel
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("8c7d3edb-c1ab-47ce-a152-f8c6c0981dad"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("3db0eba9-9441-448f-a8ef-ef89f16ea913"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("9db5fb6a-f437-4d3d-a062-547df4139b18"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("72beb0b1-0ee7-48c0-b23f-d49d553f6558"),
                            DateCreated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9377),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9393),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("d7dd38cf-ab07-4942-a817-b251c55306d3"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9550),
                            DateUpdated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9550),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("ae75d0e4-44eb-4acb-a552-a5a3a451ce78"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9553),
                            DateUpdated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9553),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a25ecd60-5e30-42d8-9aa9-f849b822a4bc"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9555),
                            DateUpdated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9555),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("f3d88a04-6719-49a4-aace-492cda5f0092"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9557),
                            DateUpdated = new DateTime(2022, 2, 24, 11, 13, 47, 54, DateTimeKind.Local).AddTicks(9558),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
