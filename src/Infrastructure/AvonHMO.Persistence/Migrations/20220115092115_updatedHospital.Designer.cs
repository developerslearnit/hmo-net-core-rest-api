...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220115092115_updatedHospital")]
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("86ff51a6-69e2-42ee-899f-1cbafad526fd"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("cc0b08c4-4320-4f9f-bbf9-eb812bd468a3"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("25f0fe21-de21-4c8f-85b6-db0c63f19e3d"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("1e478de9-6e23-45ca-bacd-d69c8a22f96e"),
                            DateCreated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2115),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2129),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("c90a538b-3d00-459a-80a1-0adcda99de6a"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2235),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2235),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("c837f710-415e-494c-931f-30f659f0387a"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2237),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2238),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("4e22f3a8-9297-4138-bd63-716308179c0e"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2239),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2239),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("1beae35c-c003-4283-adc3-244db97968bb"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2241),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 21, 15, 242, DateTimeKind.Local).AddTicks(2241),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
