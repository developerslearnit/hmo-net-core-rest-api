...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220115093837_UpdatedRiskAssesmentTable")]
    partial class UpdatedRiskAssesmentTable
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("2dd480aa-b811-46a7-827c-a73fe8617ccc"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("7a6da277-035b-41ce-a3df-cd37a37b26e4"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("860565ad-d276-4285-a900-8a7c669086ec"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("3cc85f52-5dd5-4d59-859a-3044b86efbc9"),
                            DateCreated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2601),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2624),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("d8c71ce3-5ca7-40e6-9659-6b8e73ab62dd"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2809),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2809),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("60ef7081-74db-4b21-9937-9867b1bb0152"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2812),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2813),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("2781dc62-75ec-440d-978c-940e58980b68"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2828),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2829),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("91181286-5218-447c-b048-10530b62622f"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2831),
                            DateUpdated = new DateTime(2022, 1, 15, 10, 38, 37, 499, DateTimeKind.Local).AddTicks(2831),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
