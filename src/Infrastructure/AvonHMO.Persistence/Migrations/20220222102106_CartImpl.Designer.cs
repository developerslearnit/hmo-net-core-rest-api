...
namespace AvonHMO.Persistence.Migrations
{
    ...
    [Migration("20220222102106_CartImpl")]
    partial class CartImpl
    {
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AppSettingId = new Guid("87c298c8-ce19-44ef-9f79-fa041d203658"),
                            Key = "SENDGRID_KEY",
                            Value = "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"
                        },
                        new
                        {
                            AppSettingId = new Guid("ad3ab5e0-3bf7-4e43-8ead-a49bae82bb8b"),
                            Key = "FROM_EMAIL",
                            Value = "no-reply@avonhmo.com.ng"
                        },
                        new
                        {
                            AppSettingId = new Guid("96e8c161-0c26-45cc-ae56-6cafbf69ec7b"),
            ...
            modelBuilder.Entity("AvonHMO.Entities.AppUserStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("a5413fff-237b-42aa-b739-1d9bb178c8a3"),
                            DateCreated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3047),
                            Email = "admin@avonhmo.com",
                            FailedPasswordTries = 0,
                            FirstName = "Avon",
                            IsActive = true,
                            IsLockedOut = false,
                            LastLoginDate = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3063),
                            LastName = "HMO",
                            MobilePhone = "234",
            ...
            modelBuilder.Entity("AvonHMO.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("aee6e917-31d9-4ffc-9227-1d1a431553eb"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3200),
                            DateUpdated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3200),
                            Deleted = false,
                            RoleName = "Admin",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("931348b5-e784-4c21-b871-226699022bbd"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3203),
                            DateUpdated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3203),
                            Deleted = false,
                            RoleName = "Enrollee",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("6cb3a6a9-937e-41bc-a763-b51f1614d850"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3215),
                            DateUpdated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3215),
                            Deleted = false,
                            RoleName = "Client",
                            UpdatedBy = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("832c7fb0-302b-4634-98c6-8548d8aea2d5"),
                            CreatedBy = "Admin",
                            DateCreated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3217),
                            DateUpdated = new DateTime(2022, 2, 22, 11, 21, 5, 665, DateTimeKind.Local).AddTicks(3217),
                            Deleted = false,
                            RoleName = "Provider",
                            UpdatedBy = "Admin"
                        });
